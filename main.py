...
def draw_floor():
    ...
    screen.blit(floor_surface, (floor_x_pos + 336, 450))
...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = high_score_surface.get_rect(center=(144, 400))  # 288,850
...
pygame.init()
screen = pygame.display.set_mode((288, 512))  # 576, 1024
...
# floor_surface = pygame.transform.scale2x(floor_surface)  # To scale the floor 2x(times)
floor_x_pos = 0
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE and game_active:
                # To move the bird upward we have to reverse the direction of the bird movement
                bird_movement = 0
                bird_movement -= 6
                flap_sound.play()
    ...
    screen.blit(bg_surface, (0, 0))  # To put one surface on another surface
